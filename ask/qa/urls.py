...
urlpatterns = [
    ...
    url(r'^signup/$', views.test, name='testsignup'),
    url(r'^question/(?P<id>[0-9]+)/$', views.test, name='show_question'),
    url(r'^ask/$', views.test, name='add_ask'),
    url(r'^popular/$', views.test, name='popular_questions'),
    url(r'^new/$', views.test, name='testnew'),
